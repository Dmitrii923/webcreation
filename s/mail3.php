...
$eles = array('ご担当者名','ご担当者名フリガナ','ご担当者電話番号','ご担当者メールアドレス','店舗名','郵便番号','店舗ご住所','店舗電話番号');
...
<header id="top">
  ...
  <div id="p_navi"><strong>ご返答メール</strong></div>

<h3 class="heading">Mail　<span id="hd">ご返答メール</span></h3>

<div id="wrap">
<section>
<div id="contact1">ご返答メール</div>
...
<div id="contact3">
※内容を確認後、審査に入らせて頂きます。<br />
審査後、審査完了メールを送らさせて頂きますのでその後ご入金をお願いします。
